...
public abstract class CameraActivityClass extends AppCompatActivity
  ...
  protected abstract void convertYUV420SPToARGB8888(byte[] bytes, int previewWidth, int previewHeight, int[] rgbBytes);
          ...
          CameraConnectionFragment.newInstance(
              new CameraConnectionFragment.ConnectionCallback() {
                ...
                public void onPreviewSizeChosen(final Size size, final int rotation) {
                  ...
                  CameraActivityClass.this.onPreviewSizeChosen(size, rotation);
                }
              },
              this,
              getLayoutId(),
